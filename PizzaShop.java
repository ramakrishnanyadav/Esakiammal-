...
public class PizzaShop {
    ...
    private static final List<String> pizzaMenu = new ArrayList<>();
    private static final List<Double> pizzaPrices = new ArrayList<>();
    private static final List<String> orderedPizzas = new ArrayList<>();
    private static final List<Integer> quantities = new ArrayList<>();
    private static final List<Double> orderPrices = new ArrayList<>();
